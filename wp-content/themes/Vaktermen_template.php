...
<?php while ( have_posts() ) : the_post(); ?>   
 ...
 <!--top color section-->
            ...
            <div class="row">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="current_breadcrumb active" aria-current="page">Vaktermen</li>
                    </ol>
                </nav> -->
            </div>
        </div>
    ...
    <!--vaktermen content-->
    <section class="vaktermen_content">
        <div class="container">
            <div class="col-md-12">
                <div class="vaktermen_content_text">
                    <?php the_content(); ?>
                </div>
            </div>
        </div>
